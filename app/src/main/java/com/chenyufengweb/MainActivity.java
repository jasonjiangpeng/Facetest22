            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        Response response1 = commonOperate.detectByte(getBitmap(R.drawable.item10), 0, null);
                        ...
                        String base64 = Base64.encodeToString(getBitmap(R.drawable.item3), Base64.NO_WRAP);
